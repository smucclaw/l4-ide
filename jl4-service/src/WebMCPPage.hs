...
renderExplorerPageBS = LBS.fromStrict $ Text.Encoding.encodeUtf8 $ Text.unlines
  ...
  , "        <dt>Discovery</dt>"
  , "        <dd><code>GET /.well-known/mcp</code> returns the MCP discovery document.<br>"
  , "            <code>GET /.well-known/mcp/manifest</code> returns the MCP manifest.</dd>"
  , "      </dl>"
  , "      <p style=\"margin-top: 0.75rem;\"><strong>Example config</strong> (for .claude.json):</p>"
