...
addNlgForSrcRange srcRange i = do
  modifying' #nlgMap $
    IV.insert (IV.srcRangeToInterval srcRange) i
...
setAnnNlgOfResolved nlg = traverseName (setAnnNlg nlg)

setAnnResolvedTypeOfResolved :: Type' Resolved -> Maybe TermKind -> Resolved -> Check Resolved
setAnnResolvedTypeOfResolved t k = traverseName (setAnnResolvedType t k)

setAnnResolvedKindOfResolved :: Kind -> Resolved -> Check Resolved
setAnnResolvedKindOfResolved k = traverseName (setAnnResolvedKind k)

setAnnResolvedAsTypeVar :: Resolved -> Check Resolved
setAnnResolvedAsTypeVar = traverseName setAnnTypeVar
