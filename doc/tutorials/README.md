...
- **[Publish Deployments to AI Agents (Gateway Discovery)](legalese-cloud/agent-marketplace.md)** - Install one discovery skill; the agent searches and runs the right rule via the `legalese` CLI (scales to many deployments)
