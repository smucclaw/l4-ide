...
See [Tutorial Suggestions](tutorial-suggestions.md) for a list of planned tutorials and ideas for new content. Contributions welcome!
...
- **Audience:** Who this tutorial is for
- **Prerequisites:** What you need to know first
- **Time:** Estimated completion time
- **Goal:** What you'll achieve
- **Step-by-step instructions** with explanations
- **Working code examples** (linked from `/docs/examples/`)
- **Next steps:** Where to go after completing the tutorial

---

## How Tutorials Differ from Courses

- **Tutorials** are task-focused: "How do I do X?"
...
Use tutorials when you have a specific goal. Use courses when you want to learn systematically.

---

## Contributing

Have an idea for a tutorial? Want to improve existing ones?

1. Check [Tutorial Suggestions](tutorial-suggestions.md) for planned topics
...
- **Can't find a tutorial?** Check if there's a [course module](../courses/README.md) on the topic
- **Stuck on a tutorial?** Open a [GitHub issue](https://github.com/smucclaw/l4-ide/issues)
- **Want to understand concepts?** See [Concepts](../concepts/README.md)
- **Need reference info?** Check the [Reference](../reference/README.md)
