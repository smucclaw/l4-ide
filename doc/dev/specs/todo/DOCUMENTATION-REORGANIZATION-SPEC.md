...
## Phase 1: Create `/specs` Directory
...
## Phase 2: Create New `/docs` Directory Structure
...
└── examples/                   # All L4 code examples for docs
    ├── README.md
    ├── reference/
    │   ├── keywords/
    │   ├── types/
...
5. **Examples** - Working L4 code examples (linked, not embedded)
...
### Sprint 2: Reference Documentation
1. Create GLOSSARY.md framework
2. Generate keyword reference pages (from Lexer.hs)
3. Create type reference pages
4. Create operator reference pages
5. Create syntax reference pages
6. Refine library documentation
...
- [ ] Every keyword from Lexer.hs has a reference page
...
- [ ] Concepts documentation complete and coherent
