...
| Decision-service `/query-plan` endpoint       |           ✅ | Produces `stillNeeded`, `impact`, `inputs`, `asks`; accepts bindings by label/unique/atomId. |
...
|   3 | Decision-service `/query-plan` endpoint        | `doc/todo/BOOLEAN-MINIMIZATION-SPEC.md`                                                 |   ✅ |    ✅ | `jl4-decision-service/src/Backend/DecisionQueryPlan.hs` + integration tests.                       |
