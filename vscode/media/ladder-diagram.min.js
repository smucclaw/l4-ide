var LadderDiagram = (() => {
  ...
  var AllQuantifier = class {
    ...
    constructor(children2, header) {
      ...
      this.header = header ? header : this.children.length <= 1 ? "" : this.children.length == 2 ? "both" : "all of";
    }
  };
  var AnyQuantifier = class {
    ...
    constructor(children2, header) {
      ...
      this.children = children2;
      this.header = header ? header : this.children.length <= 1 ? "" : this.children.length == 2 ? "either" : "any of";
    }
  };
  ...
  var LadderDiagram = class _LadderDiagram {
    ...
    _node_is_true(cidx) {
      ...
      return node.known == "T" && !node.isnegated || node.known == "F" && node.isnegated;
    }
    _init_events() {
      this.redraw_lines = () => {
        const bb = this.dom_diagram.getBoundingClientRect();
      ...
      this.dom_diagram.addEventListener("scroll", (event) => this.redraw_lines());
      document.addEventListener("DOMContentLoaded", (event) => this.redraw_lines());
