...
export interface components {
  schemas: {
    ...
    EvaluatorError:
      ...
      | {
          contents: components['schemas']['Literal']
          /** @enum {string} */
          tag: 'CannotHandleParameterType'
        }
      | {
          /** @enum {string} */
    ...
    Implementation: {
      ...
      implementation?: [components['schemas']['EvalBackend'], string][]
    }
    /**
     * Argument
    ...
    Reasoning: {
      payload: components['schemas']['ReasoningTree']
    }
    ReasoningTree: {
      children: components['schemas']['ReasoningTree'][]
      payload: components['schemas']['ReasonNode']
    }
    ResponseWithReason: {
      reasoning: components['schemas']['Reasoning']
      values: [string, components['schemas']['Literal']][]
    }
    SimpleResponse:
      | {
