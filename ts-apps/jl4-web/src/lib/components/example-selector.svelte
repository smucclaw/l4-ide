...
<div class="example-selector">
  ...
  <div class="button-grid">
    ...
    <button
      class="example-button external"
      onclick={() => window.open('https://github.com/smucclaw/l4-ide', '_blank')}
    >
      L4-IDE on Github
    </button>
  ...
  <div class="info-grid">
    L4 is a programming language designed specifically for translating legal documents into precise, executable code.
    Use this online-playground to tinker and share your L4 code.
  </div>
</div>
